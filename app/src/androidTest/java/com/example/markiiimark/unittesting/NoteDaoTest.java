...
public class NoteDaoTest extends NoteDatabaseTest {
    ...
    static final String TEST_TITLE = "This is a test title";
    static final String TEST_CONTENT = "This is some test content";
    static final String TEST_TIMESTAMP = "08-2018";
